...
Версия русификатора: **1.0.4**<br>
Поддерживаемая версия игры: **V1.2.13**<br>
Автор: **Disketa**
...
- Добавлена совместимость с обновлением игры **V1.2.13** от 17 сентября 2026 года.
- Скорректированы несколько строк перевода.

## Установка через установщик

1. Закройте игру и запустите `Succubus-Nightmare-RU-Setup-1.0.4.exe`.
...
Версию, поставленную установщиком, удалите через список установленных приложений Windows: **Succubus Nightmare — русификатор 1.0.4**.
