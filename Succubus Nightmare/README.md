...
- Исправлено отображение стандартного значения в настройках сцен: надпись больше не перекрывает соседнюю кнопку.
- Дополнительно проверены переносы строк во всём переводе.
