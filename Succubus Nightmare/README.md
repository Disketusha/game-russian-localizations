...
Версия русификатора: **1.0.2**<br>
Поддерживаемая версия игры: **V1.1.12**<br>
Автор: **Disketa**
...
- Переведены добавленные разработчиками титры: названия разделов, должности, персонажи и кнопка меню. Имена людей и компаний оставлены без изменений.
- Проверена совместимость с **V1.1.12** и пересобраны установщик, ручной архив и PDF-инструкция.
- Сохранены исправления длинной строки Айи, компактного значения «Стандарт» и переносов строк.

## Установка через установщик

1. Закройте игру и запустите `Succubus-Nightmare-RU-Setup-1.0.2.exe`.
...
Версию, поставленную установщиком, удалите через список установленных приложений Windows: **Succubus Nightmare — русификатор 1.0.2**.
