...
- Исправлены отдельные сюжетные реплики: восстановлены обращения, причинность и логика нескольких сцен.
- Термины приведены к единому варианту: «клеймо похоти» и «посёлок».
- Проверена совместимость с **V1.1.12** и пересобраны установщик, ручной архив и PDF-инструкция.

## Установка через установщик

1. Закройте игру и запустите `Succubus-Nightmare-RU-Setup-1.0.3.exe`.
...
Версию, поставленную установщиком, удалите через список установленных приложений Windows: **Succubus Nightmare — русификатор 1.0.3**.
