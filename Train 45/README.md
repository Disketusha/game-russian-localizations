...
Скачать готовый установщик и PDF-инструкцию: [Train 45 — русификатор 1.1.1](https://github.com/Disketusha/game-russian-localizations/releases/tag/train45-v1.1.1).

## Установка

1. Запустите `Train45-RU-Patcher-1.1.1.exe`.
