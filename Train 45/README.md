...
Версия русификатора: **1.1.5**
Поддерживаемая Steam-версия игры: **1.0.5.1**
Автор: **Disketa**

Скачать готовый установщик и PDF-инструкцию: [Train 45 — русификатор 1.1.5](https://github.com/Disketusha/game-russian-localizations/releases/tag/train45-v1.1.5).

## Установка

1. Запустите `Train45-RU-Patcher-1.1.5.exe`.
