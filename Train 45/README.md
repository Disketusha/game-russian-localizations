...
Версия русификатора: **1.1.0**  
Поддерживаемая Steam-версия игры: **1.0.5.1**  
Автор: **Disketa**

Скачать готовый установщик и PDF-инструкцию: [Train 45 — русификатор 1.1.0](https://github.com/Disketusha/game-russian-localizations/releases/tag/train45-v1.1.0).

## Установка

1. Запустите `Train45-RU-Patcher-1.1.0.exe`.
...
7. В игре откройте **Настройки → Игра → Язык** и выберите **Русский**.
...
Каталог [`game-files`](./game-files/) содержит только файлы игры, которые меняются русификатором. Материалы оформления личного установщика, рабочие архивы и внутренние заметки в публичный репозиторий не входят.
